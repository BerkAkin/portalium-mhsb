            ...
            <div class="table-responsive document-table">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th width="30%"> <?= Module::t('Product Name') ?> </th>
                        <th width="30%"> <?= Module::t('Type') ?> </th>
                        <th width="7%"> <?= Module::t('Quantity') ?> </th>
                        <th width="9%"> <?= Module::t('Price') ?> </th>
                        <th width="9%"> <?= Module::t('Tax(%)') ?> </th>
                        <th width="9%"> <?= Module::t('Total') ?> </th>

                    </tr>
                    </thead>
                    <tbody>
                    <?= $this->render('_item',['form' => $form,'modelItems' => $modelItems,'types' => $itemTypes]); ?>
                    ...
                    <tr class="document-subtotal" style="text-align: right">
                        <td colspan="6"> <?= Module::t('Subtotal') ?> </td>
                        <td class="value" ></td>
                    </tr>
...
<?php ActiveForm::end(); ?>
<?= $this->render('_company', ['model' => $companiesModel, 'types' => $types,'typesGroup'=>$typesGroup]); ?>
<?php
    ...
    */
    ...
    var calcDocumentItemChanged = function(rowItem){
        var itemTotal = rowItem.find('.item-total'),
            ...
            itemTotal_d = rowItem.find('input[data-type="total_d"]'),//Deneme Deneme Deneme Deneme
            ...
            documentTotal_d = parentTable.find('.document-total_d .value'),
    ...
    var calcDocumentInit = function(){
        ...
        tables.each(function(i,table) {
            ...
            tableItems.each(function(ii,item) {
                ...
                tableTotal.html(itemTotalValue+totalTax);
